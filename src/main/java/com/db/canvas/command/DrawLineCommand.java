...
import com.db.canvas.printer.LinePrinter;
...
public class DrawLineCommand implements Command {
    ...
    public DrawLineCommand(String[] commandArray, CanvasSheet canvasSheet) throws MalformedCommandException {
        CommandValidatorUtils.validateDrawLineCommand(commandArray, canvasSheet);
    ...
    public void execute() throws PrintException {
        Printer printer = new LinePrinter(p1, p2);
